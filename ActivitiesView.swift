            ...
            List{
                Section(){
                    ForEach(activities){ activity in
                        ActivityCardView(activityName: activity.name ?? "N/A", activityEmoji: activity.emoji ?? "📝", personName: "Name Placeholder", checked: activity.isCompleted, activity: activity)
                            .swipeActions {
